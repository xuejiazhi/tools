...
// ---*******
func (m *Bar) SetRatioTotalData(userdata float64) {
	m.RatioTotal = userdata
}

func (m *Bar) SetRatioUseData(userdata float64) {
	m.RatioUsed = userdata
}

func (m *Bar) SetRatioSuffix(suffix string) {
	m.RatioSuffix = suffix
}
